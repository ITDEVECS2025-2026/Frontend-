...
const Carddosen: React.FC<CarddosenProps> = ({
  ...
  return (
    <div
      className={clsxm(
        "w-[216px] h-[299px] rounded-3xl relative",
        className
      )}
    >

<div className='backdrop-blur-sm  border border-white/2 bg-white/0   shadow-lg rounded-b-3xl z-20 w-full h-20 absolute bottom-0 '>
          </div>
      ...
      <div className='bg-white rounded-2xl z-20 shadow-[inset_0px_-1px_4px_rgba(0,0,0,0.6)] w-[59.82px] h-[25px] absolute flex bottom-5 right-3 items-center justify-center gap-2 '>
        <Image 
